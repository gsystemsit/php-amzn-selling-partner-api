...
class VendorDirectFulfillmentOrders20211228Resource implements ResourceContract
{
    ...
    public function getOrders(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/orders/2021-12-28/purchaseOrders', $this->filterQuery([
    ...
    public function getOrder(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/orders/2021-12-28/purchaseOrders/' . rawurlencode((string) $purchase_order_number));
    ...
    public function submitAcknowledgement(
        ...
        $response = $this->http
            ...
            ->post(
                $this->endpoint . '/vendor/directFulfillment/orders/2021-12-28/acknowledgements',
