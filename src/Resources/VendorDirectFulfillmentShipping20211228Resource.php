...
class VendorDirectFulfillmentShipping20211228Resource implements ResourceContract
{
    ...
    public function getShippingLabels(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shippingLabels', $this->filterQuery([
    ...
    public function submitShippingLabelRequest(
        ...
        $response = $this->http
            ...
            ->post(
                $this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shippingLabels',
    ...
    public function getShippingLabel(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shippingLabels/' . rawurlencode((string) $purchase_order_number));
    ...
    public function createShippingLabels(
        string $purchase_order_number,
        array $request_body
    ): CreateShippingLabelsResponse|ErrorListResponse {
        $response = $this->http
            ->responseClass(CreateShippingLabelsResponse::class)
            ->post(
                $this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shippingLabels/' . rawurlencode((string) $purchase_order_number),
                deep_array_conversion($request_body),
            );
    ...
    public function submitShipmentConfirmations(
        ...
        $response = $this->http
            ...
            ->post(
                $this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shipmentConfirmations',
                deep_array_conversion($request_body),
            );
    ...
    public function submitShipmentStatusUpdates(
        ...
        $response = $this->http
            ...
            ->post(
                $this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/shipmentStatusUpdates',
                deep_array_conversion($request_body),
            );
    ...
    public function getCustomerInvoices(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/customerInvoices', $this->filterQuery([
                'createdAfter' => $created_after,
                'createdBefore' => $created_before,
                'shipFromPartyId' => $ship_from_party_id,
                'limit' => $limit,
    ...
    public function getCustomerInvoice(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/customerInvoices/' . rawurlencode((string) $purchase_order_number));
    ...
    public function getPackingSlips(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/packingSlips', $this->filterQuery([
                'createdAfter' => $created_after,
                'createdBefore' => $created_before,
                'shipFromPartyId' => $ship_from_party_id,
                'limit' => $limit,
    ...
    public function getPackingSlip(
        ...
        $response = $this->http
            ...
            ->get($this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/packingSlips/' . rawurlencode((string) $purchase_order_number));
    ...
    public function createContainerLabel(
        array $request_body
    ): CreateContainerLabelResponse|ErrorListResponse {
        $response = $this->http
            ->responseClass(CreateContainerLabelResponse::class)
            ->post(
                $this->endpoint . '/vendor/directFulfillment/shipping/2021-12-28/containerLabel',
                deep_array_conversion($request_body),
            );
